...
#undef PREP
    ...
    #define PREP_RECOMPILE_START    if (isNil "wrt_fnc_recompile") then {wrt_recompiles = []; wrt_fnc_recompile = {{call _x} forEach wrt_recompiles;}}; private _recomp = {
    #define PREP_RECOMPILE_END      }; call _recomp; wrt_recompiles pushBack _recomp;
#else
